...
public class EntradaySalida {
	...
	public static void main(String[] args) {
		...
		//En este caso, hay q separar la unidad de los decimales mediante una coma, si lo hacemos con un punto nos dara error.
		...
		//FLOAT
		System.out.println("Introduce el numero floar que quieras leer:");
		float numero4 = sc.nextFloat();
		System.out.println("El numero elegido ha sido el numero:"+ numero4);
		//Pasa lo mismo que con el numero double, no podemos separar los decimales
		//mediante un punto porque nos dara error.
		...
		System.out.println("La suma de los dos numeros introducidos es igual a:"+ numero8);
